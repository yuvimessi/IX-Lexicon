...
@Component({
  selector: 'app-client-association-ysix2',
  templateUrl: './client-association-ysix2.component.html',
  styleUrls: ['./client-association-ysix2.component.scss'],
  encapsulation: ViewEncapsulation.Emulated
})
export class ClientAssociationYsix2Component implements OnInit, OnDestroy, AfterViewInit {
