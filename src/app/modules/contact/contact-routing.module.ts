...
import { ClientAssociationYsixComponent } from './client-association-ysix/client-association-ysix.component';
import { ClientAssociationYsix2Component } from './client-association-ysix2/client-association-ysix2.component';
const routes: Routes = [
  {
    path: 'all-contact',
  ...
  /////////////////////////////changes here - start/////////////////////////////////////
  {
    path: 'client-associations-ysix',
    component: ClientAssociationYsixComponent,
    canActivate: [ContactGuard],
    data: { type: 'view' }
  },

  {
    path: 'client-associations-ysix2',
    component: ClientAssociationYsix2Component,
    canActivate: [ContactGuard],
    data: { type: 'view' }
  },
  /////////////////////////////changes here -end////////////////////////////////////////
