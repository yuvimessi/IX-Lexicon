...
export class SidebarComponent implements OnInit, OnDestroy {
  ...
  getCurrentURL() {
    ...
    else if (this.currentURL.includes('/contact/client-associations-ysix2') || this.currentURL.includes('/contact/create-client-association')
    || this.currentURL.includes('/contact/edit-client-association')) {
    this.currentNavigateURL = 'contactClientAssociationsYSIX2';}
    
    
    
    else if (this.currentURL.includes('/contact/client-associations-ysix') || this.currentURL.includes('/contact/create-client-association')
    || this.currentURL.includes('/contact/edit-client-association')) {
    this.currentNavigateURL = 'contactClientAssociationsYSIX';}
